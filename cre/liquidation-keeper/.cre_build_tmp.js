...
var file_capabilities_blockchain_evm_v1alpha_client = /* @__PURE__ */ fileDesc("", [file_sdk_v1alpha_sdk, file_tools_generator_v1alpha_cre_metadata, file_values_v1_values]);
...
class AbiDecodingDataSizeTooSmallError2 extends BaseError5 {
...
class AbiDecodingZeroDataError2 extends BaseError5 {
  constructor({ cause } = {}) {
...
class AbiFunctionNotFoundError2 extends BaseError5 {
...
class AbiFunctionOutputsNotFoundError2 extends BaseError5 {
  constructor(functionName, { docsPath }) {
    super([
...
class AbiItemAmbiguityError extends BaseError5 {
  constructor(x, y) {
...
class InvalidAbiDecodingTypeError2 extends BaseError5 {
  constructor(type, { docsPath }) {
    super([
...
class InvalidDefinitionTypeError2 extends BaseError5 {
  constructor(type) {
    super([
...
class InvalidBytesBooleanError2 extends BaseError5 {
  constructor(bytes) {
...
function hexToNumber4(hex, opts = {}) {
  const value2 = hexToBigInt3(hex, opts);
...
function keccak2562(value2, to_) {
  const to = to_ || "hex";
  const bytes = keccak_256(isHex3(value2, { strict: false }) ? toBytes3(value2) : value2);
  if (to === "bytes")
    return bytes;
  return toHex2(bytes);
}
...
class NegativeOffsetError extends BaseError5 {
  constructor({ offset }) {
...
class PositionOutOfBoundsError extends BaseError5 {
  constructor({ length, position }) {
    super(`Position \`${position}\` is out of bounds (\`0 < position < ${length}\`).`, { name: "PositionOutOfBoundsError" });
  }
}

class RecursiveReadLimitExceededError extends BaseError5 {
...
function bytesToBigInt2(bytes, opts = {}) {
  if (typeof opts.size !== "undefined")
    assertSize3(bytes, { size: opts.size });
  const hex = bytesToHex4(bytes, opts);
...
function encodeBytes(value2, { param }) {
  ...
  if (!paramSize) {
    ...
    return {
      dynamic: true,
      encoded: concat2([padHex3(numberToHex2(bytesSize, { size: 32 })), value_])
    };
  }
...
function decodeAbiParameters2(params, data) {
  const bytes = typeof data === "string" ? hexToBytes4(data) : data;
...
function decodeAddress(cursor) {
  ...
  return [checksumAddress2(bytesToHex4(sliceBytes2(value2, -20))), 32];
}
function decodeArray(cursor, param, { length, staticPosition }) {
  if (!length) {
    const offset = bytesToNumber2(cursor.readBytes(sizeOfOffset));
    const start = staticPosition + offset;
    const startOfData = start + sizeOfLength;
    cursor.setPosition(start);
    const length2 = bytesToNumber2(cursor.readBytes(sizeOfLength));
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value2 = bytesToHex4(cursor.readBytes(Number.parseInt(size4, 10), 32));
  return [value2, 32];
}
function decodeNumber(cursor, param) {
  ...
  const value2 = cursor.readBytes(32);
  return [
    size4 > 48 ? bytesToBigInt2(value2, { signed }) : bytesToNumber2(value2, { signed }),
    32
  ];
}
...
function decodeString(cursor, { staticPosition }) {
  ...
  const value2 = bytesToString2(trim2(data));
  cursor.setPosition(staticPosition + 32);
  return [value2, 32];
}
...
var hash = (value2) => keccak2562(toBytes3(value2));
...
function normalizeSignature(signature) {
  ...
  if (!valid)
    throw new BaseError5("Unable to normalize signature.");
  return result;
}
var toSignature = (def) => {
  const def_ = (() => {
...
var toEventSelector3 = toSignatureHash;
var toFunctionSelector3 = (fn) => slice2(toSignatureHash(fn), 0, 4);
function getAbiItem2(parameters) {
  ...
  const abiItems = abi.filter((abiItem) => {
    if (isSelector) {
      if (abiItem.type === "function")
        return toFunctionSelector3(abiItem) === name;
      if (abiItem.type === "event")
        return toEventSelector3(abiItem) === name;
      return false;
    }
...
function decodeFunctionResult2(parameters) {
  ...
  if (functionName) {
    ...
    if (!item)
      throw new AbiFunctionNotFoundError2(functionName, { docsPath });
    abiItem = item;
  }
  if (abiItem.type !== "function")
    throw new AbiFunctionNotFoundError2(undefined, { docsPath });
  if (!abiItem.outputs)
    throw new AbiFunctionOutputsNotFoundError2(abiItem.name, { docsPath });
...
function prepareEncodeFunctionData2(parameters) {
  ...
  if (functionName) {
    ...
    if (!item)
      throw new AbiFunctionNotFoundError2(functionName, { docsPath: docsPath2 });
    abiItem = item;
  }
  if (abiItem.type !== "function")
    throw new AbiFunctionNotFoundError2(undefined, { docsPath: docsPath2 });
  return {
    abi: [abiItem],
    functionName: toFunctionSelector3(formatAbiItem2(abiItem))
  };
}
function encodeFunctionData2(parameters) {
  ...
  const data = "inputs" in abiItem && abiItem.inputs ? encodeAbiParameters2(abiItem.inputs, args ?? []) : undefined;
  return concatHex2([signature, data ?? "0x"]);
}
...
var modifiers2 = new Set([
  "memory",
  "indexed",
  "storage",
  "calldata"
]);
var eventModifiers2 = new Set(["indexed"]);
var functionModifiers2 = new Set([
  "calldata",
  "memory",
  "storage"
]);
...
class BaseError7 extends Error {
  constructor(shortMessage, args = {}) {
    const details = args.cause instanceof BaseError7 ? args.cause.details : args.cause?.message ? args.cause.message : args.details;
    const docsPath3 = args.cause instanceof BaseError7 ? args.cause.docsPath || args.docsPath : args.docsPath;
    const message = [
      shortMessage || "An error occurred.",
      "",
      ...args.metaMessages ? [...args.metaMessages, ""] : [],
...
class UnknownTypeError3 extends BaseError7 {
  constructor({ type }) {
    super("Unknown type.", {
      metaMessages: [
        `Type "${type}" is not a valid ABI type. Perhaps you forgot to include a struct signature?`
...
class UnknownSolidityTypeError2 extends BaseError7 {
  constructor({ type }) {
    super("Unknown type.", {
      metaMessages: [`Type "${type}" is not a valid ABI type.`]
    });
...
class InvalidParameterError3 extends BaseError7 {
  constructor({ param }) {
    super("Invalid ABI parameter.", {
      details: param
    });
...
class SolidityProtectedKeywordError3 extends BaseError7 {
  constructor({ param, name }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
...
class InvalidModifierError3 extends BaseError7 {
  constructor({ param, type, modifier }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
...
class InvalidFunctionModifierError3 extends BaseError7 {
  constructor({ param, type, modifier }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
...
class InvalidAbiTypeParameterError3 extends BaseError7 {
  constructor({ abiParameter }) {
    super("Invalid ABI parameter.", {
      details: JSON.stringify(abiParameter, null, 2),
      metaMessages: ["ABI parameter type is invalid."]
...
class InvalidSignatureError3 extends BaseError7 {
  constructor({ signature, type }) {
    super(`Invalid ${type} signature.`, {
      details: signature
    });
...
class UnknownSignatureError3 extends BaseError7 {
  constructor({ signature }) {
...
class InvalidStructSignatureError3 extends BaseError7 {
  constructor({ signature }) {
    super("Invalid struct signature.", {
      details: signature,
      metaMessages: ["No properties exist."]
...
class CircularReferenceError3 extends BaseError7 {
  constructor({ type }) {
    super("Circular reference detected.", {
      metaMessages: [`Struct "${type}" is a circular reference.`]
    });
...
class InvalidParenthesisError3 extends BaseError7 {
  constructor({ current, depth }) {
    super("Unbalanced parentheses.", {
      metaMessages: [
        `"${current.trim()}" has too many ${depth > 0 ? "opening" : "closing"} parentheses.`
...
function parseSignature5(signature, structs = {}) {
  ...
  throw new UnknownSignatureError3({ signature });
}
function parseFunctionSignature(signature, structs = {}) {
  const match = execFunctionSignature2(signature);
  if (!match)
    throw new InvalidSignatureError3({ signature, type: "function" });
  const inputParams = splitParameters2(match.parameters);
  const inputs = [];
  const inputLength = inputParams.length;
  for (let i2 = 0;i2 < inputLength; i2++) {
    inputs.push(parseAbiParameter4(inputParams[i2], {
  ...
  if (match.returns) {
    ...
    for (let i2 = 0;i2 < outputLength; i2++) {
      outputs.push(parseAbiParameter4(outputParams[i2], {
        modifiers: functionModifiers2,
        structs,
        type: "function"
      }));
...
function parseEventSignature(signature, structs = {}) {
  ...
  if (!match)
    throw new InvalidSignatureError3({ signature, type: "event" });
  const params = splitParameters2(match.parameters);
  const abiParameters = [];
  const length = params.length;
  for (let i2 = 0;i2 < length; i2++)
    abiParameters.push(parseAbiParameter4(params[i2], {
...
function parseErrorSignature(signature, structs = {}) {
  ...
  if (!match)
    throw new InvalidSignatureError3({ signature, type: "error" });
  const params = splitParameters2(match.parameters);
  const abiParameters = [];
  const length = params.length;
  for (let i2 = 0;i2 < length; i2++)
    abiParameters.push(parseAbiParameter4(params[i2], { structs, type: "error" }));
  return { name: match.name, type: "error", inputs: abiParameters };
}
function parseConstructorSignature(signature, structs = {}) {
  const match = execConstructorSignature2(signature);
  if (!match)
    throw new InvalidSignatureError3({ signature, type: "constructor" });
  const params = splitParameters2(match.parameters);
  const abiParameters = [];
  const length = params.length;
  for (let i2 = 0;i2 < length; i2++)
    abiParameters.push(parseAbiParameter4(params[i2], { structs, type: "constructor" }));
  return {
    type: "constructor",
    stateMutability: match.stateMutability ?? "nonpayable",
...
function parseFallbackSignature(signature) {
  ...
  if (!match)
    throw new InvalidSignatureError3({ signature, type: "fallback" });
  return {
    type: "fallback",
    stateMutability: match.stateMutability ?? "nonpayable"
  };
...
function parseAbiParameter4(param, options) {
  ...
  if (!match)
    throw new InvalidParameterError3({ param });
  if (match.name && isSolidityKeyword2(match.name))
    throw new SolidityProtectedKeywordError3({ param, name: match.name });
  const name = match.name ? { name: match.name } : {};
  const indexed = match.modifier === "indexed" ? { indexed: true } : {};
  const structs = options?.structs ?? {};
  let type;
  ...
  if (isTuple) {
    ...
    const length = params.length;
    for (let i2 = 0;i2 < length; i2++) {
      components_.push(parseAbiParameter4(params[i2], { structs }));
    }
    components = { components: components_ };
  } else if (match.type in structs) {
    type = "tuple";
...
function splitParameters2(params, result = [], current = "", depth = 0) {
  ...
  if (current === "")
    return result;
  if (depth !== 0)
    throw new InvalidParenthesisError3({ current, depth });
  result.push(current.trim());
  return result;
}
function isSolidityType2(type) {
  return type === "address" || type === "bool" || type === "function" || type === "string" || bytesRegex2.test(type) || integerRegex3.test(type);
}
...
function isSolidityKeyword2(name) {
  return name === "address" || name === "bool" || name === "function" || name === "string" || name === "tuple" || bytesRegex2.test(name) || integerRegex3.test(name) || protectedKeywordsRegex2.test(name);
}
...
function parseStructs2(signatures) {
  ...
  for (let i2 = 0;i2 < signaturesLength; i2++) {
    ...
    if (!match)
      throw new InvalidSignatureError3({ signature, type: "struct" });
    const properties = match.properties.split(";");
    const components = [];
    const propertiesLength = properties.length;
    for (let k = 0;k < propertiesLength; k++) {
      ...
      if (!trimmed)
        continue;
      const abiParameter = parseAbiParameter4(trimmed, {
        type: "struct"
      });
      components.push(abiParameter);
    }
    if (!components.length)
      throw new InvalidStructSignatureError3({ signature });
    shallowStructs[match.name] = components;
  }
  const resolvedStructs = {};
  const entries = Object.entries(shallowStructs);
...
function resolveStructs2(abiParameters = [], structs = {}, ancestors = new Set) {
  ...
  for (let i2 = 0;i2 < length; i2++) {
    ...
    if (isTuple)
      ...
      if (!match?.type)
        throw new InvalidAbiTypeParameterError3({ abiParameter });
      const { array, type } = match;
      if (type in structs) {
        if (ancestors.has(type))
          throw new CircularReferenceError3({ type });
        components.push({
          ...abiParameter,
          type: `tuple${array ?? ""}`,
        ...
        if (isSolidityType2(type))
          ...
          throw new UnknownTypeError3({ type });
      }
    }
  }
  return components;
...
function parseAbi3(signatures) {
  ...
  for (let i2 = 0;i2 < length; i2++) {
    ...
    if (isStructSignature2(signature))
      continue;
    abi.push(parseSignature5(signature, structs));
  }
  return abi;
}
var liquidationFacetAbi = parseAbi3([
...
var VAULTS_REPORT_PARAMS = "address[] vaults";
var onCronTrigger = (runtime2) => {
  const cfg = runtime2.config;
  runtime2.log(`[keeper] scanning vault health on ${cfg.chainName} (hub ${cfg.hubAddress})`);
  const network286 = getNetwork({ chainFamily: "evm", chainSelectorName: cfg.chainName });
  if (!network286) {
  ...
  const call = evmClient.callContract(runtime2, {
    call: encodeCallMsg({
      from: zeroAddress2,
      to: cfg.hubAddress,
      data: callData
  ...
  const decoded = decodeFunctionResult2({
    abi: liquidationFacetAbi,
    functionName: "getLiquidatableVaults",
    data: bytesToHex3(call.data)
  });
  const vaultsRaw = decoded[0];
  const vaults = [];
  for (let i2 = 0;i2 < vaultsRaw.length; i2++) {
    const v = vaultsRaw[i2];
    if (v && v !== zeroAddress2) {
      vaults.push(v);
    }
  }
  if (vaults.length === 0) {
    runtime2.log("[keeper] all scanned vaults are >= 120% CR — nothing to flag");
    return "healthy: 0 vaults flagged";
  }
  runtime2.log(`[keeper] ${vaults.length} undercollateralized vault(s): ${vaults.join(", ")}`);
  const reportPayload = encodeAbiParameters2(parseAbiParameters2(VAULTS_REPORT_PARAMS), [vaults]);
  const report2 = runtime2.report(prepareReportRequest(reportPayload)).result();
  const writeResult = evmClient.writeReport(runtime2, {
    receiver: cfg.registryAddress,
    report: report2,
    gasConfig: { gasLimit: cfg.gasLimit }
  }).result();
  const txHash = bytesToHex3(writeResult.txHash || new Uint8Array(32));
  runtime2.log(`[keeper] flagged ${vaults.length} vault(s) — tx ${txHash} (${writeResult.txStatus})`);
